<div data-role="footer" style="text-align:center" data-position="fixed" data-fullscreen="true">
    ...
    <a href="<?php echo $this->Html->url(array('controller'=>'Users', 'action'=>'email_login')) ;?>" class="button" id="color-orange" data-icon="mail" data-iconpos="left" rel="external">メルアドではじめる</a>
