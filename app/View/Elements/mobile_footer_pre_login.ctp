<div data-role="footer" style="text-align:center" data-position="fixed" data-fullscreen="true">
	<a href="<?php echo $this->Html->url(array('controller'=>'Users', 'action'=>'facebook')) ;?>" class="button" id="color-orange" data-icon="fb" data-iconpos="left" rel="external">Facebookではじめる</a>
